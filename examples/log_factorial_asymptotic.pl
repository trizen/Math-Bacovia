...
((-n) + ((1/2) * log(2)) + ((1/2) * log(log(-1))) + ((1/2) * log(-i)) + (log(n) * n) + ((1/2) * log(((((((1/6) * 72 * n * 6531840 * n^4) + (6531840 * n^4) + (9871 * 72 * n))/(72 * n * 6531840 * n^4)) - (((31/6480) * n^-2) + ((139/155520) * n^-3))) + n))))
