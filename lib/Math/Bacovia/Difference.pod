...
Return a true value when C<x> and C<y> are sybolically equal.
...
=head2 inside
    ...
    my ($minuend, $subtrahend) = $obj->inside;

Returns the internal minuend and subtrahend of the self-object.
